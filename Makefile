...
RM = rm -f
RMDIR = rm -rf
INC = -I src  -I /opt/local/miniaudio/include
...
ifdef CONFIG_W32
    ...
    ifdef CONFIG_MIN
        ...
        INC = -I src -I /opt/local/glfw-3.3.4.bin.WIN32/include -I /opt/local/mingw-std-threads-1.0.0 -I /opt/local/portaudio-i686-w64/include -I /opt/local/miniaudio/include
        ...
        INC = -I src -I /opt/local/SFML-i686/include -I /opt/local/glfw-3.3.4.bin.WIN32/include -I /opt/local/mingw-std-threads-1.0.0 -I /opt/local/portaudio-i686-w64/include -I /opt/local/miniaudio/include
...
ifdef CONFIG_W64
    ...
    ifdef CONFIG_MIN
        ...
        INC = -I src -I/opt/local/SFML-x86_64/include -I /opt/local/glfw-3.3.4.bin.WIN64/include -I /opt/local/mingw-std-threads-1.0.0 -I /opt/local/portaudio-x86_64-w64/include -I /opt/local/miniaudio/include
